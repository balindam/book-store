package com.balindam.order_service.testdata;

import static org.instancio.Select.field;

import com.balindam.order_service.domain.models.Address;
import com.balindam.order_service.domain.models.CreateOrderRequest;
import com.balindam.order_service.domain.models.Customer;
import com.balindam.order_service.domain.models.OrderItem;
...
public class TestDataFactory {
    ...
    static final Set<OrderItem> VALID_ORDER_ITEMS =
            Set.of(new OrderItem("P200", "The Night Circus", new BigDecimal("25.99"), 1));
